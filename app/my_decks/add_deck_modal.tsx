...
export default function AddDeckModal(props: {
  ...
  return (
    <Dialog open={props.isAddDeckOpen} onClose={() => props.onClose()} className="relative z-50">
      <div className="fixed inset-0 flex w-screen items-center justify-center p-4">
        <DialogPanel className="max-w-lg min-w-lg space-y-4 border border-gray-500 p-12 bg-gray-800 rounded-xl shadow-lg">
          <DialogTitle className="font-bold">Adding New Deck</DialogTitle>
          <div className="mb-6">
          ...
          {addDeckError && <p className="text-red-500">Error: {addDeckError}</p>}
          <Button onClick={handleNewDeckSubmit}>Save</Button>
